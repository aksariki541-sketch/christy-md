...
// Asal       : plugins/rpg/huntzone.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .marketstall, .foodshop, .7eleven, .buyfood, .buydrink
...
handler.command = ['marketstall', 'foodshop', '7eleven', 'buyfood', 'buydrink']

export default handler;
handler.category = 'Fun'
handler.description = 'Huntzone'
