...
// Asal       : plugins/rpg/rpg-reward.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: claim→claim2, monthly→monthly2
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .harian, .claim2, .mingguan, .weekly, .monthly2, .bulanan
...
handler.command = ['harian', 'claim2', 'mingguan', 'weekly', 'monthly2', 'bulanan']
...
handler.description = 'Rpg-reward'
