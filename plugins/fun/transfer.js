...
// Asal       : plugins/rpg/transfer.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: tf→tf2, transfer→transfer2
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .tf2, .transfer2
...
handler.command = ['tf2', 'transfer2']

export default handler
handler.category = 'Fun'
handler.description = 'Transfer'
