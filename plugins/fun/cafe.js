...
// Asal       : plugins/rpg/cafe.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .cafemenu, .cafeopen, .cafeupgrade, .cafestock, .cafeadd, .caferename, .cafelist
...
handler.command = ['cafemenu', 'cafeopen', 'cafeupgrade', 'cafestock', 'cafeadd', 'caferename', 'cafelist']

export default handler;
handler.category = 'Fun'
handler.description = 'Cafe'
