...
// Asal       : plugins/rpg/petualanganpremium.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .petualanganpremium, .premiumadventure
...
handler.command = ['petualanganpremium', 'premiumadventure']
handler.group = true
handler.premium = true

export default handler;
handler.category = 'Fun'
handler.description = 'Petualanganpremium'
