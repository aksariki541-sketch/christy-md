...
// Asal       : plugins/rpg/pasar.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: jual→jual2
...
handler.command = ['pasar', 'jual2']
handler.group = true
export default handler
handler.category = 'Fun'
handler.description = 'Pasar'
