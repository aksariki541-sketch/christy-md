...
// Asal       : plugins/rpg/marketplace.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: 7eleven→7eleven2, foodshop→foodshop2, marketstall→marketstall2, buyfood→buyfood2
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .7eleven2, .foodshop2, .marketstall2, .buyfood2
...
handler.command = ['7eleven2', 'foodshop2', 'marketstall2', 'buyfood2']

export default handler
handler.category = 'Fun'
handler.description = 'Marketplace'
