...
// Asal       : plugins/game/game-nyerah.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: nyerah→nyerah2
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .nyerah2, .skip, .surrender
...
handler.command = ['nyerah2', 'skip', 'surrender']

export default handler
handler.category = 'Fun'
handler.description = 'Game-nyerah'
