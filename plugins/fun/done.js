...
// Asal       : plugins/store/done.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: done→done2
...
handler.command = ['done2']
handler.owner = true

export default handler
handler.category = 'Fun'
handler.description = 'Done'
