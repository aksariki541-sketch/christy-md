...
// Asal       : plugins/game/game-slot.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: slot→slot2
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .slot2, .slots, .jackpot
...
handler.command = ['slot2', 'slots', 'jackpot']
