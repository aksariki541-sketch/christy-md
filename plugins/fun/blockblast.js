...
// Asal       : plugins/game/blockblast.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .blockblast, .blockgame, .blockpuzzle, .block

/**
 * =============================================================
 * NAME : BLOCK BLAST MINI
 * AUTHOR : Mommy Kyuu
 * CHANNEL : https://
...
handler.description = 'Main game Block Blast Mini interaktif via Hirara Rich Message';
handler.command = ['blockblast', 'blockgame', 'blockpuzzle', 'block'];

handler.category = 'Fun'
handler.description = 'Blockblast'
