...
// Asal       : plugins/store/addlist.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: addlist→addlist2, list→list3, dellist→dellist2
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .addlist2, .list3, .dellist2
...
handler.command = ['addlist2', 'list3', 'dellist2']
handler.group = true
handler.admin = true
