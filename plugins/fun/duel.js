...
// Asal       : plugins/rpg/duel.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: skip→skip2
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .duel, .gass, .skip2
...
handler.command = ['duel', 'gass', 'skip2']
handler.group = true;
