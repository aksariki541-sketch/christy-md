...
// Asal       : plugins/store/payment.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .pay, .addpay, .delpay, .listpay
...
import { proto, generateWAMessageContent, generateWAMessageFromContent } from '../../lib/baileys.js'
...
handler.command = ['pay', 'addpay', 'delpay', 'listpay']
handler.group = true
handler.owner = true

export default handler
handler.category = 'Fun'
handler.description = 'Payment'
