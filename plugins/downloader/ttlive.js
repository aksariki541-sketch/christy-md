...
// ikuti shortlink (tinyurl, s.id, dll) sampai ketemu URL TikTok
...
handler.help = ['ttlive <link>']
handler.tags = ['downloader']
handler.command = /^(ttlive|ttl|tiktok|tt|tiktokdl|ttdl)$/i
handler.limit = true
