...
import { proto, generateWAMessageFromContent, generateWAMessageContent } from 'baileys'
...
handler.help = ['tt', 'tiktok', 'ttimg', 'tiktokimg']
handler.tags = ['downloader']
handler.command = /^(tt|tiktok|ttimg|tiktokimg|ttslide)$/i
handler.limit = true
