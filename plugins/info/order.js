...
// Asal       : plugins/main/order.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .sewa, .premium
...
✨ Terima kasih telah menggunakan Christy MD`,
 thumbnail: fs.readFileSync(ROOT + '/media/thumb.jpg')
 }, {
 quoted: m
 })
 }
...
handler.command = ['sewa', 'premium']

handler.category = 'Main'
handler.description = 'Order'
