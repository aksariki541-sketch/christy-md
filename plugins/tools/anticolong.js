...
// Asal       : plugins/tools/anticolong.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .setattr, .stattr, .anticolong
...
let handler = async (m, { conn }) => {
 ...
 "sticker-pack-name": "🔒 Locked by Kanoo",
 "sticker-pack-publisher": "Kanoo Osakaa",
 "accessibility-text": "🔒 Locked by Kanoo",
...
handler.command = ['setattr', 'stattr', 'anticolong'];
handler.category = 'Tools'
handler.description = 'Anticolong'
