...
// Asal       : plugins/tools/dashlive.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .dashlive, .dashboardlive, .statusbotlive
...
handler.command = ['dashlive', 'dashboardlive', 'statusbotlive']

handler.category = 'Tools'
handler.description = 'Dashlive'
