...
// Asal       : plugins/tools/codepromt.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .promptcode, .detectbug, .convertcode, .explaincode, .imagesolve
...
handler.command = ['promptcode', 'detectbug', 'convertcode', 'explaincode', 'imagesolve']
handler.category = 'Tools'
handler.description = 'Codepromt'
