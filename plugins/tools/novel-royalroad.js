...
// Asal       : plugins/internet/novel-royalroad.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .rrsearch, .detail, .latest, .profile
...
handler.command = ['rrsearch', 'detail', 'latest', 'profile']

handler.category = 'Tools'
handler.description = 'Royalroad'
