...
// Asal       : plugins/internet/fetch.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: fetch→fetch2
...
handler.command = ['fetch2', 'get']

export default handler
handler.category = 'Tools'
handler.description = 'Fetch'
