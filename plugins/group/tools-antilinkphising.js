...
// Asal       : plugins/group/tools-antilinkphising.js (paket plugin Drive)
...
handler.onMessage = async (m, { conn, isBotAdmin }) => {
  if (!m.isGroup) return
...
handler.description = 'Tools-antilinkphising'
