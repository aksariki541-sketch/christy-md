...
// Asal       : plugins/downloader/down-spdl.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: spotify→spotify2
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .spotifydl, .spotify2, .sdown, .spdl
...
${caption}`,
        ...
        linkPreview: {
          ...
          title: result.title,
          description: `🎧 Christy MD • ${result.artist}`,
          previewType: 0,
          jpegThumbnail: thumb,
...
handler.command = ['spotifydl', 'spotify2', 'sdown', 'spdl']
