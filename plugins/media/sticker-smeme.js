...
// Asal       : plugins/sticker/sticker-smeme.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: smeme→smeme2
...
handler.command = ['smeme2']

export default handler
handler.category = 'Media'
handler.description = 'Sticker-smeme'
