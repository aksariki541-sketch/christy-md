...
// Asal       : plugins/maker/fakegroup.js (paket plugin Drive)
...
let handler = async (m, { conn, text }) => {
  ...
  if (args.length < 4) {
    throw `Contoh:
.fakegroup Christy MD|500|Mabar bot|06/03/26 15:31`
  }
...
handler.command = ['fakegroup']

export default handler
handler.category = 'Media'
handler.description = 'Fakegroup'
