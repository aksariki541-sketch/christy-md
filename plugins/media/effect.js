...
// Asal       : plugins/audio/effect.js (paket plugin Drive)
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .bass, .blown, .deep, .earrape, .nightcore, .robot
...
handler.command = ['bass', 'blown', 'deep', 'earrape', 'nightcore', 'robot'];

handler.category = 'Media'
handler.description = 'Effect'
