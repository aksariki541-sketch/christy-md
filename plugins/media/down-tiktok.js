...
// Asal       : plugins/downloader/down-tiktok.js (diambil dari Nakano-Miku-MD.zip (zip sumber di dalam paket))
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .ttdl2, .tiktok4, .tt4, .tiktokdl3
// Catatan    : command bentrok diganti: ttdl→ttdl2, tiktok→tiktok4, tt→tt4, tiktokdl→tiktokdl3
...
handler.command = ['ttdl2', 'tiktok4', 'tt4', 'tiktokdl3']
...
handler.description = 'Down-tiktok'
