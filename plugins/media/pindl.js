...
// Asal       : plugins/downloader/pindl.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: pin→pin2, pinterest→pinterest2, pinvid→pinvid2
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .pin2, .pinterest2, .pinvid2, .pinvideo
...
handler.command = ['pin2', 'pinterest2', 'pinvid2', 'pinvideo']

export default handler
handler.category = 'Media'
handler.description = 'Pindl'
