...
// Asal       : plugins/voice/voice-audio.js (paket plugin Drive)
// Catatan    : command bentrok dengan yang sudah ada, diganti: bass→bass2, blown→blown2, deep→deep2, earrape→earrape2, nightcore→nightcore2, robot→robot2, blown2→blown22, reverse→reverse2, bass2→bass22
// Penyesuaian: handler.command jadi array, properti handler.* yang tidak didukung dibuang,
//              kategori/deskripsi ditambahkan, branding base lama dibersihkan.
// Command    : .bass2, .bassboost, .treble, .blown2, .deep2, .earrape2, .fast, .fat, .nightcore2, .slow, .tupai, .squirrel, .chipmunk, .helium, .demon, .robot2, .echo, .echo2, .reverb, .reverb2, .telephone, .radio, .megaphone, .underwater, .distortion, .metal, .blown22, .smooth, .clean, .normalize, .loud, .volumeup, .volumedown, .reverse2, .vibra, .tremolo, .8d, .stereo, .wide, .karaoke, .ghost, .haunted, .bass22, .treble2, .soft, .compressor
...
handler.command = ['bass2', 'bassboost', 'treble', 'blown2', 'deep2', 'earrape2', 'fast', 'fat', 'nightcore2', 'slow', 'tupai', 'squirrel', 'chipmunk', 'helium', 'demon', 'robot2', 'echo', 'echo2', 'reverb', 'reverb2', 'telephone', 'radio', 'megaphone', 'underwater', 'distortion', 'metal', 'blown22', 'smooth', 'clean', 'normalize', 'loud', 'volumeup', 'volumedown', 'reverse2', 'vibra', 'tremolo', '8d', 'stereo', 'wide', 'karaoke', 'ghost', 'haunted', 'bass22', 'treble2', 'soft', 'compressor']

export default handler
handler.category = 'Media'
handler.description = 'Voice-audio'
